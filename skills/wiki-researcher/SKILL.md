...
description: Deep, evidence-grounded investigation of "how does X work" across many files. Architectural reasoning for complex systems, pattern investigation, and wiki-grade answers backed by source citations. Activated by slash-command or referenced from `system-dissector` deep-dive.
