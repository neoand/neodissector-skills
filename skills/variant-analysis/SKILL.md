...
description: Pattern-based hunt for similar vulnerabilities and bug variants across codebases. Builds CodeQL/Semgrep queries from a seed finding, audits security regressions, performs systematic code audits. Companion to security-scanning tools.
